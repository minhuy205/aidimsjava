...
public class TechnicianAuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponse> technicianLogin(@RequestBody LoginRequest request) {
    ...
    @GetMapping("/validate")
    public ResponseEntity<String> validateTechnicianAccess() {
        return ResponseEntity.ok("Technician access validated");
    }
}